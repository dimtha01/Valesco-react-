...
import imgContrato from "../assets/administration.png"; // Nueva imagen para la tercera tarjeta

const InicioAdministraciónContratos = () => {
  return (
    <>
      <div className="breadcrumbs text-sm md:text-lg mx-2 mt-2 text-[#0f0f0f]">
        <ul className="flex items-center space-x-2">
          <li>
            <Link
              to="/InicioAdministracionContratos"
      ...
      <div className="container mx-3 mt-8 px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
          {/* Tarjeta Administración de Contratos */}
          <div className="card bg-white shadow-md rounded-lg overflow-hidden transition-transform duration-300 hover:scale-105 hover:shadow-lg">
            <figure className="h-48 overflow-hidden">
              <img
                src={imgContrato} // Reemplaza imgContrato con la imagen correspondiente
                alt="Administración de Contratos"
            ...
            <div className="card-body p-4 text-center">
              ...
              <p className="text-xs md:text-sm text-gray-600 mt-2">
                Gestión integral de Valuaciones
              </p>
...
export default InicioAdministraciónContratos